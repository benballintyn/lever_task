...
datadir = '~/phd/lever_task/simple_rl/bandit_utility_func1_softmax_largeSweep';
...
performance = load([datadir '/performance.mat']); performance=performance.performance;
if (use_e_greedy)
...
for i=1:n3
    ...
    for j=1:n1
        for k=1:n2
            ...
            if (performance(j,k,i) > maxROE)
                maxROE = performance(j,k,i);
