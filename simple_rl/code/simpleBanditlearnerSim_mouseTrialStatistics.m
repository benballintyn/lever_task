        ...
        parfor s=1:4
            ...
            for nt = 1:length(mouseTrialNums{s})
                [curnumSR,curnumLR,curnS,curnL,RoEoptimalities,EoRoptimalities] = ...
                    simpleRLsim(sessType,mouseTrialNums{s}(nt),'bandit',100,use_e_greedy,LRPressTimeFunc2,agentParams);
...
savedir = '~/phd/lever_task/simple_rl/bandit_utility_func1_softmax_largeSweep_mouseTrialStatistics';
