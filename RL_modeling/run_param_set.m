function [score] = run_param_set(params,basedir,agentType,...
    actionSelectionMethod,initializationMethod,utilityFunc1,utilityFunc2,forgettingType,...
    scoreType,modelType,run_num,varargin)
...
addRequired(p,'run_num',@isnumeric)
...
parse(p,params,basedir,agentType,actionSelectionMethod,initializationMethod,...
    utilityFunc1,utilityFunc2,forgettingType,scoreType,modelType,run_num,varargin{:})
