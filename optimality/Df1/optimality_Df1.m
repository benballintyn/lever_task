...
clear all;
do_save = 1;
mice = {'AZ01','AZ02','AZ03','AZ05','AZ07','AZ09'};
PROCESSED_DATA_PATH = '~/phd/lever_task/processed_data/Df1/';
VAR_SAVE_PATH = '~/phd/lever_task/optimality/Df1/';
...
count = zeros(1,4);
for i=1:length(mice)
    data = load([PROCESSED_DATA_PATH mice{i} '_ReProcessedData.mat']); data=data.ProcessedData;
    for j=1:length(data)
...
if (do_save)
    save([VAR_SAVE_PATH 'RoE_optimalities.mat'],'RoE_optimalities','-mat')
    save([VAR_SAVE_PATH 'EoR_optimalities.mat'],'EoR_optimalities','-mat')
    save([VAR_SAVE_PATH 'RoEs.mat'],'RoEs','-mat')
    save([VAR_SAVE_PATH 'EoRs.mat'],'EoRs','-mat')
    save([VAR_SAVE_PATH 'NL_observed.mat'],'NL_observed','-mat')
    save([VAR_SAVE_PATH 'nTrials.mat'],'nTrials','-mat')
    save([VAR_SAVE_PATH 'nTrialsCompleted.mat'],'nTrialsCompleted','-mat')
    save([VAR_SAVE_PATH 'nTrialsAborted.mat'],'nTrialsAborted','-mat')
    save([VAR_SAVE_PATH 'RoERandOptimalities.mat'],'RoERandOptimalities','-mat')
    save([VAR_SAVE_PATH 'EoRRandOptimalities.mat'],'EoRRandOptimalities','-mat')
    save([VAR_SAVE_PATH 'RoErandomComparison.mat'],'RoErandomComparison','-mat')
    save([VAR_SAVE_PATH 'EoRrandomComparison.mat'],'EoRrandomComparison','-mat')
    save([VAR_SAVE_PATH 'totalReward.mat'],'totalReward','-mat')
    save([VAR_SAVE_PATH 'totalPresses.mat'],'totalPresses','-mat')
    save([VAR_SAVE_PATH 'totalPressesSR.mat'],'totalPressesSR','-mat')
    save([VAR_SAVE_PATH 'totalPressesLR.mat'],'totalPressesLR','-mat')
    save([VAR_SAVE_PATH 'pS.mat'],'pS','-mat')
    save([VAR_SAVE_PATH 'pL.mat'],'pL','-mat')
    save([VAR_SAVE_PATH 'pSA.mat'],'pSA','-mat')
    save([VAR_SAVE_PATH 'pLA.mat'],'pLA','-mat')
end
%% Figures
figFolder = '~/phd/lever_task/figures/Df1/optimality/';
