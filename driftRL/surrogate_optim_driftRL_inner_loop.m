function [score] = surrogate_optim_driftRL_inner_loop(params,basedir,agentType,...
    actionSelectionMethod,initializationMethod,utilityFunc1,utilityFunc2)
disp(params)
...
switch agentType
    ...
    case 'Qlearner'
        ...
        if (any(strcmp(utilityFuncs,'ansUtilityFunc')))
            ...
            driftParams.noise_amplitude = params(6);
        else
            driftParams.drift_rate = params(4);
            driftParams.noise_amplitude = params(5);
        end
...
[score] = driftRL_objective_score(savedir);
